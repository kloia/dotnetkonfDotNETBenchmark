...
WORKDIR /src
COPY ["NETCore31ContainerImage.csproj", "NETCore31ContainerImage/"]
RUN dotnet restore "NETCore31ContainerImage/NETCore31ContainerImage.csproj"

WORKDIR "/src/NETCore31ContainerImage"
COPY . .
RUN dotnet build "NETCore31ContainerImage.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "NETCore31ContainerImage.csproj" \
...
Execute unit tests
```
cd "NETCore31ContainerImage/test/NETCore31ContainerImage.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "NETCore31ContainerImage/src/NETCore31ContainerImage"
